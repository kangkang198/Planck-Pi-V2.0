...
static const s16 default_init_sequence[] = {
	 ...
	 * no inversion
	 */
	-1, 0xB4, 0x03, // kangkang change 0x07

	/* PWCTR1 - Power Control
	 * -4.6V, AUTO mode
	 */
	// -1, 0xC0, 0xA2, 0x02, 0x84,
	-1, 0xC0, 0xA8, 0x0B, 0x04,
	...
	-1, MIPI_DCS_ENTER_INVERT_MODE, // kangkang change MIPI_DCS_EXIT_INVERT_MODE
